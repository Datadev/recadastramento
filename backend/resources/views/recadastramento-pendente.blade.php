...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office">
   <head>
      ...
      <title>Recadastramento pendente</title>
      <!--[if (mso 16)]>
      <style type="text/css">
                                                               ...
                                                               <tr>
                                                                  <td style="padding:20px;Margin:0" align="left">
                                                                     ...
                                                                     <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                                                        <br>Seu recadastramento está pendente.
                                                                        <br>Por favor, atualize seus dados o mais breve possível.
                                                            ...
                                                            <tbody>
                                                               ...
                                                               <tr>
                                                                  <td style="padding:0;Margin:0;padding-top:10px;padding-bottom:10px" align="center">
                                                                     <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:17px;color:#333333;font-size:11px">Este e-mail foi enviado automaticamente<br></p>
                                                                  </td>
                                                               </tr>
                                                            </tbody>
                                                         </table>
